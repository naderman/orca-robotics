...
ADD_CUSTOM_COMMAND(
    ...
    ARGS -cp ${CMAKE_CURRENT_SOURCE_DIR} -cp ${ICEJ_HOME}/Ice.jar -d ${CMAKE_CURRENT_BINARY_DIR} 
...
MESSAGE ( STATUS "${CMAKE_Java_COMPILER} -cp ${CMAKE_CURRENT_SOURCE_DIR} -cp ${ICEJ_HOME}/Ice.jar -d ${CMAKE_CURRENT_BINARY_DIR} ${CMAKE_CURRENT_BINARY_DIR}/${PROJECT_INTERFACE_NAMESPACE}/*.java" )
