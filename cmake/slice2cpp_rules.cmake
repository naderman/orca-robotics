...
IF ( DEFINED ORCA_HOME )
    SET ( SLICE_ARGS ${SLICE_PROJECT_ARGS} -I${SLICE_SOURCE_DIR} -I${ICE_SLICE_HOME}/slice -I${ORCA_HOME}/slice --stream --output-dir ${SLICE2CPP_BINARY_DIR}/${INTERFACE_NAMESPACE} )
