...
#     set( proj_slice_bin_dir        ${PROJECT_BINARY_DIR}/src/interfaces/slice )
    ...
    if( ORCA_MOTHERSHIP )
        ...
        set( generator_args ${slice_args} --module ${slice_module} --util )
    else()
...
#         message( STATUS "DEBUG: Adding rule for generating header file from ${slice_source_basename}" )
        ...
        add_custom_command(
            ...
            COMMENT "-- Generating header file of utility functions from ${slice_source}"
            VERBATIM
        )
...
#         message( STATUS "DEBUG: Adding rule for generating source file from ${slice_source_basename}" )
        ...
        add_custom_command(
            ...
            COMMENT "-- Generating source file of utility functions from ${slice_source}"
            VERBATIM
        )
