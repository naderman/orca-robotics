SET( lib_name ${PROJECT_NAME_CAP}IfaceInit )
...
IF( build )
    ...
    #
    INCLUDE( ${ORCA_CMAKE_DIR}/Slice2Init.cmake )
    ...
    #
    ORCA_GENERATE_SLICE2INIT_RULES( slice_generated_sources slice_generated_headers ${ORCA_SLICE_SOURCE_FILES} )
...
#     INCLUDE( ${GEARBOX_CMAKE_DIR}/UseGearbox.cmake )
    ...
    IF( ORCA_MOTHERSHIP )
        ...
        ADD_DEPENDENCIES( ${lib_name} slice2init )
