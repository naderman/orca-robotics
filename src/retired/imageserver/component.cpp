...
Component::start()
{
...
#else
        throw gbxutilacfr::Exception( ERROR_INFO, "Can't instantiate driver 'monoopencv' because it wasn't built!" );
    ...
    else if ( driverName == "digiclops" )
    {
        ...
        hwDriver_ = new MonoDriver( imageGrabber_, desiredCfg, context() );
#else
        throw gbxutilacfr::Exception( ERROR_INFO, "Can't instantiate driver 'digiclops' because it wasn't built!" );
