...
public:
    ...
    BufferedTimedConsumerI( int depth=1,
                            gbxsickacfr::gbxiceutilacfr::BufferType bufferType = gbxsickacfr::gbxiceutilacfr::BufferTypeCircular )
...
public:
    ...
    PtrBufferedTimedConsumerI( int depth=1, gbxsickacfr::gbxiceutilacfr::BufferType bufferType = gbxsickacfr::gbxiceutilacfr::BufferTypeCircular )
        : buffer_( depth, bufferType ) {};
