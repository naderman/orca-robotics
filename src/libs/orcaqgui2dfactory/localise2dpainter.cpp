...
void Localise2dPainter::setData( orca::Localise2dDataPtr data )
{
    if ( data == 0 ) return;
...
void Localise2dPainter::paintHypothesis( QPainter* p, const orca::Pose2dHypothesis &hypothesis )
{
...
void Localise2dPainter::paint( QPainter *painter, int z )
{
    if ( data_ == 0 ) return;
