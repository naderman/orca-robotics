...
public:
    ...
    hydroutil::Store<orca::PropertiesData> &localGetRemotelySetDataStore()
...
private:
    ...
    hydroutil::Store<orca::PropertiesData> dataStore_;
    hydroutil::Store<orca::PropertiesData> remotelySetDataStore_;
