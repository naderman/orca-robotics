...
public:
    ...
    virtual ::orca::FeatureMap2dData getData(const Ice::Current&)
...
void 
FeatureMap2dImpl::initInterface( gbxiceutilacfr::Thread* thread, const std::string& subsysName, int retryInterval )
{
...
FeatureMap2dImpl::localSetAndSend( const orca::FeatureMap2dData& data )
{
    ...
    orcaice::tryPushToIceStormWithReconnect<orca::FeatureMap2dConsumerPrx,orca::FeatureMap2dData>
        ( context_,
          publisherPrx_,
          data,
          topicPrx_,
