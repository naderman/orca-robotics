...
std::string 
toString( const bros1::CartesianPoint2d& obj )
{
    std::ostringstream s;
...
int 
toCartesianPoint2d( const std::string& s, bros1::CartesianPoint2d& obj )
{
...
std::string 
toString( const bros1::CartesianPoint3d& obj )
{
    std::ostringstream s;
...
int 
toCartesianPoint( const std::string& s, bros1::CartesianPoint3d& obj )
{
    std::istringstream ss( s );
    ss >> obj.x;
    if ( !ss ) return -1;
...
std::string 
toString( const bros1::Frame2d& obj )
{
    std::ostringstream s;
...
int 
toFrame2d( const std::string& s, bros1::Frame2d& obj )
{
    std::istringstream ss( s );
    ss >> obj.p.x;
    if ( !ss ) return -1;
...
std::string 
toString( const bros1::Frame3d& obj )
{
    std::ostringstream s;
...
int 
toFrame3d( const std::string& s, bros1::Frame3d& obj )
{
    std::istringstream ss( s );
    ss >> obj.p.x;
    if ( !ss ) return -1;
...
std::string 
toString( const bros1::Size2d& obj )
{
    std::ostringstream s;
...
int 
toSize2d( const std::string& s, bros1::Size2d& obj )
{
    std::istringstream ss( s );
    ss >> obj.l;
    if ( !ss ) return -1;
...
std::string 
toString( const bros1::Size3d& obj )
{
...
int 
toSize3d( const std::string& s, bros1::Size3d& obj )
{
    std::istringstream ss( s );
    ss >> obj.l;
    if ( !ss ) return -1;
...
std::string
toString( const bros1::Twist2d &t )
{
    std::ostringstream s;
    s << " Twist2d: (v->x,v->y,w): ("
      << t.v.x << ", "
