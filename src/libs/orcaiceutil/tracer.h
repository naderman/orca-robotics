...
#ifndef ORCAICEUTIL_TRACER_H
#define ORCAICEUTIL_TRACER_H
...
//! @verbatim
//! Tracer* tracer = context().tracer();
//! if ( tracer->verbocity( orcaiceutil::Tracer::ErrorTrace, orcaiceutil::Tracer::ToAny ) ) {
...
//!     - orcaiceutil::Component sets up a tracer and tries to connect to an
...
//!     - Default: 1
//! 
//! Enum orcaiceutil::Tracer::TraceType defines types of traced
//! information. Enum orcaiceutil::Tracer::DestinationType defines possible
