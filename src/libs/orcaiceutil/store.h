...
#ifndef ORCAICEUTIL_STORE_H
#define ORCAICEUTIL_STORE_H
 ...
 *  an empty Store raises an orcaiceutil::Exception.
 * 
...
public:
    ...
    //! raises an orcaiceutil::Exception exception.
...
void Store<Type>::get( Type & obj ) const
{
    ...
    {
        throw orcaiceutil::Exception( ERROR_INFO, "trying to read from an empty Store." );
    }
}
