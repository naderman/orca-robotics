...
#ifndef ORCAICEUTIL_PROXY_H
#define ORCAICEUTIL_PROXY_H
 ...
 *  an empty proxy raises an orcaiceutil::Exception.
 * 
...
void Proxy<Type>::get( Type & obj ) const
{
    ...
    {
        throw orcaiceutil::Exception( ERROR_INFO, "trying to read from an empty proxy." );
    }
}
