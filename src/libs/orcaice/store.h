...
#ifndef ORCAICE_STORE_H
#define ORCAICE_STORE_H
 ...
 *  an empty Store raises an orcaice::Exception.
 * 
...
void Store<Type>::get( Type & obj ) const
{
    ...
    {
        throw orcaice::Exception( ERROR_INFO, "trying to read from an empty Store." );
    }
}
