...
*/    
    ...
    {
        stringstream ss;
        ss << "RawRxData::"<<__func__<<"(): Received CAN packet with id 0x"<<std::hex<<pkt.id()<<".  This is a velocityCommand packet generated by the UI processor, we shouldn't see it.";
