...
void
UsbFtdiRmpIo::enable( int debugLevel )
{
...
//     {
//         stringstream ss;
//         ss << "UsbFtdiRmpIo::reset() Error resetting USB device: " << e.what();
//         throw Exception( ss.str() );
//     }
// }
 
// void
// UsbFtdiRmpIo::shutdown()
// {
//     if ( debugLevel_ > 0 )
...
RmpIo::RmpIoStatus
UsbFtdiRmpIo::readPacket(CanPacket &pkt)
{
    assert( usbFtdi_ != 0 );
...
RmpIo::RmpIoStatus
UsbFtdiRmpIo::readPacketNonBlocking( CanPacket* pkt )
{
    RmpIo::RmpIoStatus status;
...
RmpIo::RmpIoStatus
UsbFtdiRmpIo::readPacketBlocking( CanPacket* pkt )
{
    RmpIo::RmpIoStatus status;
...
// UsbFtdiRmpIo::readPacketPolling( CanPacket* pkt )
// {
...
void
UsbFtdiRmpIo::writePacket( const CanPacket &pkt )
{
    assert( usbFtdi_ != 0 );
    ...
    {
        stringstream ss;
        ss << "UsbFtdiRmpIo::writePacket(): Error: " << e.what();
 ...
 */
unsigned char
UsbFtdiRmpIo::usbMessageChecksum( unsigned char *msg )
{
...
// RmpUsbIo::RmpUsbStatus
// UsbFtdiRmpIo::getPacket(CanPacket* pkt)
// {
...
//     canBuffer_.pop();
//     //cout<<"UsbFtdiRmpIo::getPacket: got one packet"<<endl;
//     return RmpUsbIo::OK;
// }

void
UsbFtdiRmpIo::getPacketFromCanBuffer(CanPacket *pkt)
{
...
RmpIo::RmpIoStatus
UsbFtdiRmpIo::readFromUsbToBufferBlocking()
{
    int ret;
    try {
...
RmpIo::RmpIoStatus
UsbFtdiRmpIo::readFromUsbToBufferNonBlocking()
{
    try {
...
void
UsbFtdiRmpIo::readFromBufferToQueue()
{
    ...
    {
        //cout<<"UsbFtdiRmpIo::readFromBufferToQueue: processing chars into msg #"<<numPackets<<endl;
        ...
        while ( lookingForMsgStart )
        {
            ...
            {
                //cout<<"UsbFtdiRmpIo::readFromBufferToQueue: not enough char's :"<<(charBufferBytes_ - pos)<<endl;
                finished = true;
                break;
            }
 ...
 */
int UsbFtdiRmpIo::parseUsbToCan( CanPacket *pkt, const unsigned char *bytes )
{
    int ret;
/*
 ...
 */
int UsbFtdiRmpIo::parseCanToUsb( const CanPacket *pkt, unsigned char *bytes )
{
