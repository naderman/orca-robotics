...
#define USAGE_ARGS " <.def file> <.xml file> [--verbose]"
...
int main( int argc, char **argv )
{
    ...
    if ( verbose )
    {
        cout<< "generatexmltemplate: parsed component def: "<<endl;
    ...
    try
    {
        f << orcadef::toXmlTemplateText( def );
    ...
    {
        cerr<<e.what()<<endl;
        cerr<<"failed to convert definition file to XML app descriptor. Quiting..."<<endl;
        return EXIT_FAILURE;
    }
