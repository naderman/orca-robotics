...
// extern "C" {
//     hydrointerfaces::ImageConverterFactory *createImageConverterDriverFactory();
// }
typedef hydrointerfaces::ImageConverterFactory *ImageConverterDriverFactoryMakerFunc();
