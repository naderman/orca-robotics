...
#ifndef HYDROICEUTIL_SUBSYSTEM_THREAD_H
#define HYDROICEUTIL_SUBSYSTEM_THREAD_H
...
@note A similar class defined in libOrcaIce is used much more frequently.
It differs from this one in that catches Ice exceptions and should be used in components.
 */
