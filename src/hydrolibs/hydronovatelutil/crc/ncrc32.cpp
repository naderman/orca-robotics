...
#include <crc/ndefines.h>
#include <crc/ncrc32.h>
...
/*
 *   nTestCrc32::ulCrcTable[256] was generated with the following 
 *   standard code:
 *
 *
 *   printf("const ULONG nTestCrc32::ulCrcTable[256] =\n");
 *   int n, k;
 *   ULONG c;
 *
 *   printf("{\n");
...
static const unsigned long ulCrcTable[256] =
{
