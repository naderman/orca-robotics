 ...
 * Copyright (c) 2004-2009 Matthew Ridley
 *
...
namespace hydrogpsutil{
    
    //! enumeration of geod models
    SOEXPORT enum EGeodModel { GM_UNDEFINED=-1,
                      GM_WGS84 =0,
                      GM_GDA94,
                      GM_WGS72,
                      GM_AGD84,
    ...
    SOEXPORT void LatLon2MGA( double lat,
                     double lon,
                     double& Northing,
                     double& Easting,
                     int& Zone,
    ...
    SOEXPORT void MGA2LatLon( double Northing,
                     double Easting,
                     int Zone,
                     double& lat,
                     double& lon,
