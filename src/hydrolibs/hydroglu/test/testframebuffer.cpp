...
protected:
    ...
    virtual void initializeGL()
    {
        ...
        frameBuffer_ = new hydroglu::GLFrameBuffer("Test FrameBuffer");
        outputTexture_ =  new hydroglu::GLTexture("Test Texture", 640, 480); 
        frameBuffer_->attachTexture(outputTexture_, GL_COLOR_ATTACHMENT0_EXT);
        resize(640,480);
        resizeGL(640,480);
    }
...
private:
    ...
    hydroglu::GLFrameBufferPtr frameBuffer_;
    hydroglu::GLTexturePtr outputTexture_;
    QImage image_;
};
