...
//         const char del = ':';
    ...
    cout<<"testing substitute() with recursive default ... ";
    {
        string s="The best ${framework} is ${project}";
        vector<string> parameters;
        parameters.push_back( "project" );
        ...
        map<string,string> values, defaults;
        values["project"] = "orca-robotics";
        defaults["framework"] = "${project}";
        hydroutil::substitute( s, parameters, values, defaults );
        string expect = "The best orca-robotics is orca-robotics";
        if ( s != expect ) {
            cout<<"failed"<<endl<<"expect '"<<expect<<"' got='"<<s<<"'"<<endl;
            return EXIT_FAILURE;
        }
    ...
    cout<<"testing substitute() with recursive value ... ";
    {
        string s="The best ${framework} is ${project}";
        vector<string> parameters;
        parameters.push_back( "project" );
    ...
    cout<<"testing substitute() with insufficient recursive default ... ";
    {
        string s="The best ${framework} is ${project}";
        vector<string> parameters;
        parameters.push_back( "project" );
