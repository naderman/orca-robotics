...
// @author Alex Brooks
//
class SerialHandler : public hydroutil::Thread
{
...
public: 
    ...
    hydroutil::Buffer<TimedLmsResponse> &responseBuffer() { return responseBuffer_; }
...
private: 
    ...
    hydroutil::Buffer<TimedLmsResponse> responseBuffer_;
