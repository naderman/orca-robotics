...
typedef enum
{
  BAYER_PATTERN_BGGR,	//sony 1
  BAYER_PATTERN_GRBG,	//sony 3
  BAYER_PATTERN_RGGB,	//sony 2
  BAYER_PATTERN_GBRG	//sony 0
} bayer_pattern_t;
...
void
BayerSimple_EdgeOnly(unsigned char *src, unsigned char *dest, int sx, int sy, bayer_pattern_t type); //fixes the edges of the extracted color images
