...
#
SET (CTEST_DASHBOARD_ROOT "C:/ctests/orca/orca2-cont")
...
#
#SET (CTEST_COMMAND "ctest -D Continuous -C Debug -A \"${CTEST_SCRIPT_DIRECTORY}/${CTEST_SCRIPT_NAME}\" --interactive-debug-mode 0" )
SET (CTEST_COMMAND "ctest -D Continuous -C Debug -A \"${CTEST_BINARY_DIRECTORY}/cmake_config_report.txt\" --interactive-debug-mode 0" )
